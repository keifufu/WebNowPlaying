...
const site: Site = {
  ...
  info: {
    ...
    repeatMode: () => querySelector<RepeatMode, HTMLButtonElement>('button[data-testid="repeatButton"], button[data-testid="repeatOneButton"]', (el) => {
    ...
    shuffleActive: () => querySelector<boolean, HTMLButtonElement>('button[data-testid="shuffleButton"]', (el) => el.className.includes('Active'), false)
  },
  events: {
    setState: (state) => {
