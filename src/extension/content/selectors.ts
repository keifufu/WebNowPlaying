...
export const querySelector = <T, E extends Element>(selector: string, exec: (el: E) => T | null, defaultValue: T): T =>
  _querySelector(selector, exec, defaultValue);
export const querySelectorReport = <T, E extends Element>(selector: string, exec: (el: E) => T | null, defaultValue: T, type: InfoType): T =>
  _querySelector(selector, exec, defaultValue, type);
...
export const querySelectorEvent = <E extends Element>(selectorOrGetter: string | (() => E), action: (el: E) => any) =>
  _querySelectorEvent(selectorOrGetter, action);
export const querySelectorEventReport = <E extends Element>(selectorOrGetter: string | (() => E), action: (el: E) => any, type: EventType) =>
  _querySelectorEvent(selectorOrGetter, action, type);
