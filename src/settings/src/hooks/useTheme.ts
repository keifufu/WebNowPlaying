...
const [theme, _setTheme] = createSignal<"dark" | "light" | "konami">(
  localStorage.getItem("theme") ? (localStorage.getItem("theme") as "dark" | "light" | "konami") : isSystemDark() ? "dark" : "light"
);
const [borderColorClass, setBorderColorClass] = createSignal<"border-zinc-500" | "border-zinc-300">(
  localStorage.getItem("theme") === "konami" ? "border-zinc-300" : "border-zinc-500"
);
